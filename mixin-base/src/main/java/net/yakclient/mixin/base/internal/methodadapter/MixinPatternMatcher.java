...
public interface MixinPatternMatcher {
    static CoreMixinPatternMatcher corePatternMatcher(int type, MethodVisitor parent, Instruction insn) {
        switch (type) {
    ...
    static TreeMixinPatternMatcherBuilder treePatternMatcher() {
        return new TreeMixinPatternMatcherBuilder();
    }

    final class TreeMixinPatternMatcherBuilder {
        private final TreeMethodProxy.MethodProxyBuilder builder;

        private TreeMixinPatternMatcherBuilder() {
            this.builder = new TreeMethodProxy.MethodProxyBuilder();
        }
