...
//        insn.add(new LdcInsnNode("Byte code printed"));
...
//        insn.add(new VarInsnNode(ALOAD, 3));
        //"net/yakclient/mixin/registry/proxy/MixinProxyManager"
        //"net/yakclient/mixin/registry/FunctionalProxy$ProxyResponseData"
