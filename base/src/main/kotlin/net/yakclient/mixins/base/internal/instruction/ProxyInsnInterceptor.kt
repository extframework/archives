...
import net.yakclient.mixins.base.internal.bytecode.ByteCodeUtils.getRuntimeName
import net.yakclient.mixins.base.registry.proxy.MixinProxyManager
import net.yakclient.mixins.base.registry.proxy.MixinProxySettings
...
class ProxyInsnInterceptor(private val pointer: UUID) : DirectInsnInterceptor() {
    override fun intercept(): DirectInstruction {
        ...
        val proxyResName = getRuntimeName(MixinProxySettings::class.java)
